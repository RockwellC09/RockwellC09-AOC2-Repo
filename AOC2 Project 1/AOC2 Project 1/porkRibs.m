...
-(NSString*)calcCookingTime {
    ...
    NSString *cookTimeText = [NSString stringWithFormat: @"Your %i rack(s) of pork ribs are %@ need to cook for %.02f hours.", self.numberRibs, self.meatTypeStr, self.cookTimeHours];
    return cookTimeText;
}
